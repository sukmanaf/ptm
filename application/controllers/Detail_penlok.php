...
class Detail_penlok extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('detailPenlokModel','penlok');
	}
	...
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Pertama - Penetapan Lokasi dan Target KK - Desa';
		$data['data'] = $this->global->get_by_one('wa_targetkk',$id,'id');
		$this->skin->view('detail_penlok/index',$data);
	}

	public function get_all($id)
	{
		$get=$this->penlok->getData($id);
		$data = [];
		// echo "<pre>";
		// print_r ($get);
		// echo "</pre>";exit();
		foreach ($get as $key => $value) {
			...
			$a = [
				...
				'<a type="button" href="'.base_url('detail_penlok/edit/').$id.'/'.$value->id.'" class="btn btn-success"><i class="fas fa-edit"></i></a>'.
	...
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Pertama - Penetapan Lokasi dan Target KK - Desa - Baru';
		$data['data'] = $this->penlok->getDataKab($id);
		$data['data']['kuota_terpakai'] = $this->penlok->getKuota($id);
		$data['kec'] = $this->penlok->getKec($data['data']['kode_kab_kota']);

		$this->skin->view('detail_penlok/add',$data);
	}
	...
	public function create()
	{
		...
		$check = $this->penlok->cekDesaKel($kd_desa);
	...
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Pertama - Penetapan Lokasi dan Target KK - Desa - Edit';
		$data['datakab'] = $this->penlok->getDataKab($id_target);
		...
		$this->skin->view('detail_penlok/edit',$data);
...
/* End of file Detail_penlok.php */
/* Location: ./application/controllers/Detail_penlok.php */