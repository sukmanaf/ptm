...
class Dashboard_realisasi extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->skin->view('dashboard_realisasi/index', $data);
	}
	...
	public function get_all($idtab = '', $tahun)
	{
		...
		if ($idtab == 'pertama') {
			...
			$get = $this->global->get_all('v_dashboard_realisasi');
	...
	public function get_kab($idprov = '', $idtab)
	{
		...
		if ($idtab == 'pertama_kab') {
			...
			$get = $this->global->get_all('v_dashboard_realisasi_kab');
			foreach ($get as $key => $value) {
				$a = [
					$key + 1,
					@$value->nama_provinsi,
	...
	public function add()
	{
		...
		$this->skin->view('dashboard_realisasi/add', $data);
	}
	...
	public function create()
	{
		...
		$data = [
			...
			'kode_subsektor_usaha'	=> $this->input->post('kode_dashboard_realisasi', true),
	...
	public function edit($id = '')
	{
		...
		$data['title'] = 'Home - Master Data - Admin Pusat - dashboard_realisasi - Baru';
		$data['data'] = $this->global->get_by_one('ms_kuesioner_re10b', $id, 'id');
		$this->skin->view('dashboard_realisasi/edit', $data);
	}
...
/* End of file dashboard_realisasi.php */
/* Location: ./application/controllers/dashboard_realisasi.php */