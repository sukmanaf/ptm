...
class jenis_sektor_usaha extends CI_Controller
{
	...
	{
		$data['title'] = 'Home - Master Data - Admin Pusat - Jenis Sektor Usaha ';
		$this->skin->view('jenis_sektor_usaha/index', $data);
	}
	...
	{
		$get = $this->global->get_all('v_jenis_sektor_usaha');
		$data = [];
		foreach ($get as $key => $value) {
			$a = [
				$key + 1, @$value->kode_sektor_usaha, @$value->deskripsi_sektor_usaha, @$value->kode_subsektor_usaha, @$value->deskripsi_subsektor_usaha, @$value->kode_jenis_subsektor_usaha, @$value->deskripsi,
				'<a type="button" href="' . base_url('jenis_sektor_usaha/edit/') . $value->id . '" class="btn btn-success"><i class="fas fa-edit"></i></a>' .
	...
	public function add()
	{
		...
		$this->skin->view('jenis_sektor_usaha/add', $data);
	}
	...
	public function edit($id = '')
	{
		...
		$data['id'] = $id;
		$this->skin->view('jenis_sektor_usaha/edit', $data);
	}
...
/* End of file jenis_sektor_usaha.php */
/* Location: ./application/controllers/jenis_sektor_usaha.php */