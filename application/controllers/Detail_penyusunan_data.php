...
class Detail_penyusunan_data extends CI_Controller {
	...
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Pertama - Penyusunan Data - Desa';
		$data['data'] = $this->global->get_by_one('wa_targetkk',$id,'id');
		$this->skin->view('detail_penyusunan_data/index',$data);
	}
	...
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Pertama - Penyusunan Data - Desa - Baru';
		...
		$this->skin->view('detail_penyusunan_data/add',$data);
	}
	...
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Pertama - Penyusunan Data - Desa - Edit';
		...
		$this->skin->view('detail_penyusunan_data/edit',$data);
...
/* End of file Detail_penyusunan_data.php */
/* Location: ./application/controllers/Detail_penyusunan_data.php */