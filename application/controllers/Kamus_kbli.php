...
class Kamus_kbli extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->skin->view('kamus_kbli/index', $data);
	}
	...
	{
		$get = $this->global->get_all('ms_kamus_kbli');
		$data = [];
		foreach ($get as $key => $value) {
			$a = [
				...
				@$value->kode_kbli_e,
				@$value->nama_kbli_e,
				// '<a type="button" href="' . base_url('kamus_kbli/edit/') . $value->id . '" class="btn btn-success"><i class="fas fa-edit"></i></a>' .
	...
	public function add()
	{
		...
		$this->skin->view('kamus_kbli/add', $data);
	}
	...
	public function edit($id = '')
	{
		...
		$data['id'] = $id;
		$this->skin->view('kamus_kbli/edit', $data);
	}
...
/* End of file kamus_kbli.php */
/* Location: ./application/controllers/kamus_kbli.php */