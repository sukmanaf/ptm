...
class Detail_fasilitasi_akses extends CI_Controller {
	...
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Ketiga -  Fasilitasi Akses Pemasaran - Desa';
		$data['data'] = $this->global->get_by_one('wa_targetkk',$id,'id');
		$this->skin->view('detail_fasilitasi_akses/index',$data);
	}

	public function get_all($id)
	{

		$get=$this->fasilitasi_akses->getData($id);
		$data = [];
		foreach ($get as $key => $value) {
			$a = [
				...
				'<a type="button" href="'.base_url('detail_fasilitasi_akses/edit/').$id.'/'.$value->id.'/'.$value->kode_desa_kelurahan.'" class="btn btn-success"><i class="fas fa-plus"></i></a>'
	...
	public function add()
	{
		...
		$this->skin->view('detail_fasilitasi_akses/add',$data);
	}
	...
	public function edit($id_targetkk='',$id_targetkk_desa,$kode_desa_kelurahan)
	{
		...
		$this->skin->view('detail_fasilitasi_akses/edit',$data);
