...
class Detail_fasilitasi_infrastruktur extends CI_Controller {
	...
	{
		$data['title'] = 'Home - Entry Subject Object - Tahun Ketiga - Fasilitas Infrastruktur Pendukung';
		$this->skin->view('detail_fasilitasi_infrastruktur/index',$data);
	}

	public function data($id='')
	{
		$data['id']=$id;
		$data['title']= 'Home - Entry Subject Object - Tahun Ketiga - Fasilitas Infrastruktur Pendukung - Desa';
	...
	public function get_all($id)
	{
		...
		$get=$this->fasilitasi_infrastruktur->getData($id);
		$data = [];
		foreach ($get as $key => $value) {
			$a = [
				...
				'<a type="button" href="'.base_url('detail_fasilitasi_infrastruktur/edit/').$id.'/'.$value->id.'/'.$value->kode_desa_kelurahan.'" class="btn btn-success"><i class="fas fa-plus"></i></a>'
	...
	public function add()
	{
		...
		$data['title']= 'Home - Entry Subject Object - Tahun Ketiga - Fasilitas Infrastruktur Pendukung - Baru';
		$this->skin->view('detail_fasilitasi_infrastruktur/add',$data);
	}
	...
	public function edit($id_targetkk='',$id_targetkk_desa,$kode_desa_kelurahan)
	{
		...
		$data['nik']=$this->db->get('wa_kuesioner_re')->result();
		$data = $this->global->get_by_result('dt_fasilitasi_infrastruktur',$kode_desa_kelurahan, 'kode_desa_kelurahan');
		$strSarana = '';
		$strPrasarana = '';
		$arrJenis = [];
		...
		$this->skin->view('detail_fasilitasi_infrastruktur/edit',$data);
