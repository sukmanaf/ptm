...
class Pemetaan_sosial extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('pemsosModel','pemsos');
	}
	...
	public function create()
	{
		...
		$checkWil = $this->pemsos->cekWIlTahun($kd_kabkot,$thn_anggaran);
	...
	public function upload_sk1($id)
        {
        	...
        	if ($_FILES['file_foto_sk1']) {
                ...
                $config['upload_path']          = './uploads/pemetaan_sosial/';
            ...
            if ($_FILES['files']['name']) {
                ...
                else
                {
                	...
                	$data = [
	                    			...
	                    			'dir_name' => 'uploads/pemetaan_sosial/'.$this->upload->data()['file_name'],
	                			];
	                	$this->db->where('id', $id);
