...
class Klasifikasi_sektor_usaha extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->skin->view('klasifikasi_sektor_usaha/index', $data);
	}
	...
	public function get_all()
	{
		...
		foreach ($get as $key => $value) {
			$a = [
				$key + 1, @$value->deskripsi_sektor_usaha, @$value->deskripsi_subsektor_usaha, @$value->deskripsi,
				// '<a type="button" href="' . base_url('klasifikasi_sektor_usaha/edit/') . $value->id . '" class="btn btn-success"><i class="fas fa-edit"></i></a>' .
	...
	public function add()
	{
		...
		$this->skin->view('klasifikasi_sektor_usaha/add', $data);
	}
	...
	public function edit($id = '')
	{
		...
		$data['id'] = $id;
		$this->skin->view('klasifikasi_sektor_usaha/edit', $data);
	}
...
/* End of file klasifikasi_sektor_usaha.php */
/* Location: ./application/controllers/klasifikasi_sektor_usaha.php */