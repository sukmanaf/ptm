	...
	<div class="container-fluid">
		<div class="card card-outline card-primary">
			<div class="card-header">
				<a style="float: right" href="<?= base_url('detail_instansi_swasta/add') ?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
	...
	function loadDt() {
		$('#table-front').DataTable({
			ajax: {
				url: '<?php echo base_url(); ?>detail_instansi_swasta/get_all',
				data: function(d) {
	...
	function dels(id) {
		$.get("<?= base_url('detail_instansi_swasta/delete/') ?>" + id, function(response) {
