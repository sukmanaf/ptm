	  ...
	  <div class="card card-outline card-primary">
	    <div class="card-header">
	      ...
	      <div class="card-tools">
	      	      <!-- <a  style="float: right" href="<?=base_url('penetapan_model/add')?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
    ...
    function loadDt() {
    	$('#table-front').DataTable({
		    ajax: {
		        url: '<?php echo base_url();?>penetapan_model/get_all',
		        data: function ( d ) {
    ...
    function dels(id) {
    	$.get( "<?=base_url('penetapan_model/delete/')?>"+id, function( response ) {
		  	response = JSON.parse(response)
        	if (response.sts == 'success') {
