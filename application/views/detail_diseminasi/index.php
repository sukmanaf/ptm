    ...
    <div class="container-fluid">
	  <div class="card card-outline card-primary">
	    <div class="card-header">
	    	<a style="" href="<?=base_url('/diseminasi')?>" class="btn btn-default">
...
<script type="text/javascript">
    ...
    function loadDt() {
    	$('#table-front').DataTable({
		    ajax: {
		        url: '<?php echo base_url('detail_diseminasi/get_all/').$id;?>',
		        data: function ( d ) {
    ...
    function del(id) {
    	$.get( "<?=base_url('detail_diseminasi/delete/')?>"+id, function( response ) {
