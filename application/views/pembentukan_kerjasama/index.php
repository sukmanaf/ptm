	  ...
	  <div class="card card-outline card-primary">
	    <div class="card-header">
	      ...
	      <div class="card-tools">
	      	      <!-- <a  style="float: right" href="<?=base_url('pembentukan_kerjasama/add')?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("pembentukan_kerjasama/edit_realisasi") ?>'; //get form action url
    ...
    function loadDt() {
    	$('#table-front').DataTable({
		    ajax: {
		        url: '<?php echo base_url();?>pembentukan_kerjasama/get_all',
		        data: function ( d ) {
    ...
    function realisasi(kode_kab_kota,tahun_anggaran) {
    	...
    	$.get( "<?php echo base_url("pembentukan_kerjasama/getRealisasi/") ?>"+kode_kab_kota+'/'+tahun_anggaran, function( data ) {
	    	...
	    	if (data==null) {
		    	...
		    	$('#anggaran').val(rupiah(data.anggaran_kerjasama))
		    	$('#realisasi').val(rupiah(data.realisasi_kerjasama))
