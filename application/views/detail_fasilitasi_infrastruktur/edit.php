				              	...
				              	<div class="row">
					                <div class="col-md-4">
										<div class="form-group">
											...
											<input name="keberadaan_ada"   id="keberadaan_ada" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
					                <div class="col-md-4">
										<div class="form-group">
											<label for="keberadaan_tidak_ada">Tidak Ada</label>
											<input name="keberadaan_tidak_ada" id="keberadaan_tidak_ada" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
					                <div class="col-md-4">
										<div class="form-group c-sarana">
											<label for="keberadaan_kosong">Kosong</label>
											<input name="keberadaan_kosong" id="keberadaan_kosong" type="text" value="" class="numbers form-control clear">
										</div>
				              	...
				              	<div class="row">
					                <div class="col-md-3">
										<div class="form-group">
											...
											<input name="kondisi_baik" id="kondisi_baik" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
					                <div class="col-md-3">
										<div class="form-group">
											<label for="kondisi_cukup">Cukup</label>
											<input name="kondisi_cukup" id="kondisi_cukup" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
					                <div class="col-md-3">
										<div class="form-group">
											<label for="kondisi_kurang">Kurang</label>
											<input name="kondisi_kurang" id="kondisi_kurang" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
					                <div class="col-md-3">
										<div class="form-group c-sarana" >
											<label for="kondisi_kosong">Kosong</label>
											<input name="kondisi_kosong" id="kondisi_kosong" type="text" value="" class="numbers form-control clear">
										</div>
										<div class="form-group c-prasarana spy">
				              	...
				              	<div class="row">
					                <div class="col-md-4">
										<div class="form-group">
											...
											<input name="kepemilikan_individu" id="kepemilikan_individu" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
					                <div class="col-md-4">
										<div class="form-group">
											<label for="kepemilikan_komunal">Komunal</label>
											<input name="kepemilikan_komunal" id="kepemilikan_komunal" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
					                <div class="col-md-4">
										<div class="form-group">
											<label for="kepemilikan_lainnya">Lainnya</label>
											<input name="kepemilikan_lainnya" id="kepemilikan_lainnya" type="text" value="" class="numbers form-control clear">
										</div>
									</div>
				          		</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="row">
									<div class="col">
										<div class="form-group">
											<a href="<?=base_url('detail_fasilitasi_infrastruktur/data/').$id_targetkk?>" class="form-control btn btn-secondary"><label >Tutup</label></a>
										</div>
									</div>
									<div class="col">
										<div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
			...
			// console.log(jsontab)
	        var post_url = '<?php echo base_url("detail_fasilitasi_infrastruktur/update") ?>'; //get form action url
    ...
    function dels(id) {
	    $.get( "<?php echo base_url("detail_fasilitasi_infrastruktur/delete/") ?>"+id, function( response ) {
			response = JSON.parse(response)
        	if (response.sts == 'success') {
