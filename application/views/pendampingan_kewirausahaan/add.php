...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("pendampingan_kewirausahaan/create") ?>'; //get form action url
    ...
    function provChange(prov) {
	    event.preventDefault(); //prevent default action 
		$.get( "<?php echo base_url("pendampingan_kewirausahaan/getKab/") ?>"+prov, function( data ) {
