			...
			<div class="card-body">
				<form action="#" id="postForm" class="form-horizontal" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="kode_sub_sub_sektor_usaha">Kode Sub Sektor Usaha</label>
								<input name="kode_sub_sektor_usaha" maxlength="4" id="kode_sub_sektor_usaha" type="text" value="<?= $data['kode_subsektor_usaha'] ?>" class="form-control clear">
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="row">
								<div class="col">
									<div class="form-group">
										<a href="<?= base_url('sub_sektor_usaha') ?>" class="form-control btn btn-secondary"><label>Tutup</label></a>
									</div>
								</div>
								<div class="col">
									<div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#postForm").submit(function(event) {
			var kode = $("#kode_sub_sektor_usaha").val()
			...
			var post_url = '<?php echo base_url("sub_sektor_usaha/update") ?>'; //get form action url
			...
			$.ajax({
				...
				if (response.sts == 'success') {
					...
					$('.clear').val("")
					window.location.replace('<?= base_url("sub_sektor_usaha") ?>');
	...
	function tampil_data(table, colum, id) {
		var url = ''
		var tadata = ''
		urls = "<?php echo base_url(); ?>sub_sektor_usaha/tampildata/" + table + "/" + colum + "/" + id;
		$.ajax({
			url: urls,
