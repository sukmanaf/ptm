			...
			<div class="card-body">
				<form action="#" id="postForm" class="form-horizontal" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="kode_sub_sektor_usaha">Kode Sub Sektor Usaha</label>
								<input name="kode_sub_sektor_usaha" maxlength="4" id="kode_sub_sektor_usaha" type="text" value="" class="form-control clear">
							</div>
						</div>
					</div>
					<div class="row">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#postForm").submit(function(event) {
			...
			var post_url = '<?php echo base_url("sub_sektor_usaha/create") ?>'; //get form action url
	...
	function nikChange(key) {
		event.preventDefault(); //prevent default action 
		$.get("<?php echo base_url("sub_sektor_usaha/detailNik/") ?>" + key, function(data) {
