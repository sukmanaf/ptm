...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#postForm").submit(function(event) {
			...
			var post_url = '<?php echo base_url("group_instansi_swasta/create") ?>'; //get form action url
	...
	function nikChange(key) {
		event.preventDefault(); //prevent default action 
		$.get("<?php echo base_url("group_instansi_swasta/detailNik/") ?>" + key, function(data) {
