				              	...
				              	<div class="row">
					                ...
					                <div class="col-md-3">
										<div class="form-group">
											...
											<input name="besar" id="besar" type="text" value="<?=$data['besar']?>" class="form-control clear">
										</div>
									</div>
				          		</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input name="variabel_klasifikasi"  id="variabel_klasifikasi" type="text" value="<?=$data['variabel_klasifikasi']?>" class="form-control clear">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="row">
									<div class="col">
										<div class="form-group">
											<a href="<?=base_url('master_skala_usaha')?>" class="form-control btn btn-secondary"><label >Tutup</label></a>
										</div>
									</div>
									<div class="col">
										<div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("master_skala_usaha/update") ?>'; //get form action url
	        ...
	        $.ajax({
	        	...
	        	if (response.sts == 'success') {
	        		...
	        		$('.clear').val("")
	        		window.location.replace('<?= base_url("master_skala_usaha")?>');
    ...
    function nikChange(nik) {
	    event.preventDefault(); //prevent default action 
		$.get( "<?php echo base_url("master_skala_usaha/detailNik/") ?>"+nik, function( data ) {
