	...
	<div class="container-fluid">
		<div class="card card-outline card-primary">
			<div class="card-header">
				<a style="float: right" href="<?= base_url('jenis_pendampingan/add') ?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
	...
	function loadDt() {
		$('#table-front').DataTable({
			ajax: {
				url: '<?php echo base_url(); ?>jenis_pendampingan/get_all',
				data: function(d) {
	...
	function dels(id) {
		$.get("<?= base_url('jenis_pendampingan/delete/') ?>" + id, function(response) {
