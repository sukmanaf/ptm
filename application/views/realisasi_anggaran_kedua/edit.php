...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var dt = tampil_data('v_realisasi_anggaran_kedua', 'id', id);
		...
		$("#anggaran_kelembagaan").val(dt[0].anggaran_kelembagaan)
		$("#anggaran_kewirausahaan").val(dt[0].anggaran_kewirausahaan)
		$("#anggaran_kerjasama").val(dt[0].anggaran_kerjasama)
		$("#anggaran_penyusunan_sk").val(dt[0].anggaran_penyusunan_sk)
		$("#realisasi_kelembagaan").val(dt[0].realisasi_kelembagaan)
		$("#realisasi_kewirausahaan").val(dt[0].realisasi_kewirausahaan)
		$("#realisasi_kerjasama").val(dt[0].realisasi_kerjasama)
		$("#realisasi_penyusunan_sk").val(dt[0].realisasi_penyusunan_sk)
		$("#sisa_anggaran_kelembagaan").val(dt[0].sisa_anggaran_kelembagaan)
		$("#sisa_anggaran_kewirausahaan").val(dt[0].sisa_anggaran_kewirausahaan)
		$("#sisa_anggaran_kerjasama").val(dt[0].sisa_anggaran_kerjasama)
		$("#sisa_anggaran_penyusunan_sk").val(dt[0].sisa_anggaran_penyusunan_sk)
		$("#persentase_kelembagaan").val(dt[0].persentase_kelembagaan)
		$("#persentase_kewirausahaan").val(dt[0].persentase_kewirausahaan)
		$("#persentase_kerjasama").val(dt[0].persentase_kerjasama)
		$("#persentase_penyusunan_sk").val(dt[0].persentase_penyusunan_sk)
		...
		$("#postForm").submit(function(event) {
			...
			var post_url = '<?php echo base_url("realisasi_anggaran_kedua/update") ?>'; //get form action url
			...
			$.ajax({
				...
				if (response.sts == 'success') {
					...
					$('.clear').val("")
					window.location.replace('<?= base_url("realisasi_anggaran_kedua") ?>');
