					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="jenis_pemberdayaan">Jenis Pemberdayaan</label>
								<input name="jenis_pemberdayaan" id="jenis_pemberdayaan" type="text" value="" class="form-control clear">
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#postForm").submit(function(event) {
			...
			var post_url = '<?php echo base_url("model_pemberdayaan/create") ?>'; //get form action url
