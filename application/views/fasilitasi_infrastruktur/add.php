...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("fasilitasi_infrastruktur/create") ?>'; //get form action url
    ...
    function provChange(kode) {
	    event.preventDefault(); //prevent default action 
		$.get( "<?php echo base_url("fasilitasi_infrastruktur/getKab/") ?>"+kode, function( data ) {
    ...
    function kabChange(kode) {
	    event.preventDefault(); //prevent default action 
		$.get( "<?php echo base_url("fasilitasi_infrastruktur/getKec/") ?>"+kode, function( data ) {
			data = JSON.parse(data)
			console.log(data)
			$('#kec').html(data)
			$('#kel').html('<option>-- Pilih Desa/Kelurahan --</option>')
    ...
    function kecChange(kode) {
	    event.preventDefault(); //prevent default action 
		$.get( "<?php echo base_url("fasilitasi_infrastruktur/getKel/") ?>"+kode, function( data ) {
			data = JSON.parse(data)
			console.log(data)
			$('#kel').html(data)
			$('#jml_kk').val('')
    ...
    function kelChange(kode) {
	    event.preventDefault(); //prevent default action 
		// $.get( "<?php echo base_url("fasilitasi_infrastruktur/getKK/") ?>"+kode, function( data ) {
		// 	data = JSON.parse(data)
		// 	console.log(data)
		console.log(kode)
			$('#jml_kk').val(kode)
