	  ...
	  <div class="card card-outline card-primary">
	    <div class="card-header">
	      ...
	      <div class="card-tools">
	      	      <!-- <a  style="float: right" href="<?=base_url('penyusunan_sk/add')?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("penyusunan_sk/edit_realisasi") ?>'; //get form action url
    ...
    function loadDt() {
    	$('#table-front').DataTable({
		    ajax: {
		        url: '<?php echo base_url();?>penyusunan_sk/get_all',
		        data: function ( d ) {
    ...
    function realisasi(kode_kab_kota,tahun_anggaran) {
    	...
    	$.get( "<?php echo base_url("penyusunan_sk/getRealisasi/") ?>"+kode_kab_kota+'/'+tahun_anggaran, function( data ) {
	    	...
	    	if (data==null) {
		    	...
		    	$('#anggaran').val(rupiah(data.anggaran_penyusunan_sk))
		    	$('#realisasi').val(rupiah(data.realisasi_penyusunan_sk))
