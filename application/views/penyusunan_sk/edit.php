	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<iframe id="sk1_prewview" src="<?=base_url('uploads/penyusunan_sk/').$data['file_foto_sk1']?>" class="w-100" style="height:500px" frameborder="0"></iframe>
			</div>
...
<div class="modal fade" id="modal-2">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				<iframe id="sk2_prewview" src="<?=base_url('uploads/penyusunan_sk/').$data['file_foto_sk2']?>" class="w-100" style="height:500px;width: 100%" frameborder="0"></iframe>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("penyusunan_sk/update") ?>'; //get form action url
