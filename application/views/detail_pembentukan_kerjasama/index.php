    ...
    <div class="container-fluid">
	  <div class="card card-outline card-primary">
	    <div class="card-header">
	      	<a  style="" href="<?=base_url('pembentukan_kerjasama')?>" class="btn btn-default">
	        <i class="fas fa-arrow-left mr-2 text-white"></i>Kembali </a>
	      <div class="card-tools">
	      	      <!-- <a  style="float: right" href="<?=base_url('detail_pembentukan_kerjasama/add/').$id?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
    ...
    function loadDt() {
    	$('#table-front').DataTable({
		    ajax: {
		        url: '<?php echo base_url("detail_pembentukan_kerjasama/get_all/").$id;?>',
		        data: function ( d ) {
    ...
    function dels(id) {
    	$.get( "<?=base_url('detail_pembentukan_kerjasama/delete/')?>"+id, function( response ) {
