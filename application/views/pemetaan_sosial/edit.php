						...
						<div class="row">
							<div class="col-md-6">
								<div class="row">
									<div class="col">
										<div class="form-group">
											<a href="<?=base_url('pemetaan_sosial')?>" class="form-control btn btn-secondary"><label >Tutup</label></a>
										</div>
									</div>
									<div class="col">
										<div class="form-group">
	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<iframe id="sk1_prewview" src="<?=base_url('uploads/pemetaan_sosial/').$data['file_foto_sk1']?>" class="w-100" style="height:500px" frameborder="0"></iframe>
			</div>
...
<div class="modal fade" id="modal-2">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				<iframe id="sk2_prewview" src="<?=base_url('uploads/pemetaan_sosial/').$data['file_foto_sk2']?>" class="w-100" style="height:500px;width: 100%" frameborder="0"></iframe>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("pemetaan_sosial/update") ?>'; //get form action url
