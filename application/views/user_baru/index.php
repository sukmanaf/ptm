	...
	<div class="container-fluid">
		<div class="card card-outline card-primary">
			<div class="card-header">
				<a style="float: right" href="<?= base_url('user_baru/add') ?>" class="btn btn-warning pull-right">
...
<script type="text/javascript">
	...
	function loadDt() {
		$('#table-front').DataTable({
			ajax: {
				url: '<?php echo base_url(); ?>user_baru/get_all',
				data: function(d) {
	...
	function dels(id) {
		$.get("<?= base_url('user_baru/delete/') ?>" + id, function(response) {
