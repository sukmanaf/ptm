			...
			<div class="card-body">
				<form action="#" id="postForm" class="form-horizontal" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="kode_dashboard_field_staff">Kode Sub Sektor Usaha</label>
								<input name="kode_dashboard_field_staff" maxlength="4" id="kode_dashboard_field_staff" type="text" value="" class="form-control clear">
							</div>
						</div>
					</div>
					<div class="row">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#postForm").submit(function(event) {
			...
			var post_url = '<?php echo base_url("dashboard_field_staff/create") ?>'; //get form action url
	...
	function nikChange(key) {
		event.preventDefault(); //prevent default action 
		$.get("<?php echo base_url("dashboard_field_staff/detailNik/") ?>" + key, function(data) {
