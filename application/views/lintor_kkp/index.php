								...
								<div class="row">
									<div class="col">
										<div class="form-group">
											...
											<a class="btn btn-success form-control" target="_blank" href="<?php echo base_url('lintor_kkp/download_template'); ?>">Download Template Excel</a>
...
<script type="text/javascript">
	...
	function loadDt() {
		$('#table-front').DataTable({
			ajax: {
				url: '<?php echo base_url(); ?>lintor_kkp/get_all',
				data: function(d) {
	...
	function dels(id) {
		$.get("<?= base_url('lintor_kkp/delete/') ?>" + id, function(response) {
			response = JSON.parse(response)
			if (response.sts == 'success') {
