					...
					<li class='nav-item '>
						...
						<ul class="nav nav-treeview">
							<li class='nav-item '>
								...
								<ul class="nav nav-treeview">
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_pusat/sektor_usaha' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
												<p>Sektor Usaha</p>
											</a>
										</li>
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_pusat/sub_sektor_usaha' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
												<p>Sub Sektor Usaha</p>
											</a>
										</li>
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_pusat/jenis_sub_sektor_usaha' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
												<p>Jenis Sektor Usaha</p>
											</a>
										</li>
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_pusat/model_pemberdayaan' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
												<p>Model Pemberdayaan</p>
											</a>
										</li>
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_pusat/jenis_pendampingan' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
												<p>Jenis Pendampingan</p>
											</a>
										</li>
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_pusat/group_instansi_swasta' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
										...
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_pusat/realisasi_anggaran' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
							...
							<li class='nav-item  '>
								...
								<ul class="nav nav-treeview">
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_daerah/detail_instansi_swasta' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
												<p>Detail Instansi / Swasta</p>
											</a>
										</li>
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_daerah/data_field_staff' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
												<p>Data Field Staff</p>
											</a>
										</li>
										<li class="nav-item">
											<a href='http://194.233.71.171/ptm-web/master_data/admin_daerah/kamus_sektor_usaha' class="nav-link">
												<i class='nav-icon fa-circle far'></i>
