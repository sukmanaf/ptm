									...
									<div class="card card-primary">
										...
										<div class="card-body row">
											<div class="form-group col-md-6">
												...
												<input name='nip' id='fc_nip' type='text' maxlength="18" required value='' class="form-control" id="nip" name="nip" placeholder="NIP">
												
											</div>
											<div class="form-group col-md-6">
												<label for='fc_nama_pejabat'>Nama Pejabat</label>
												<input  name='nama_pejabat' id='fc_nama_pejabat' required type='text' value='' class="form-control" id="nama_pejabat" name="nama_pejabat" placeholder="Nama Pejabat">
									...
									<div class="card card-primary">
										...
										<div class="card-body row">
											...
											<div class="form-group col-md-6">
												...
												<input  id='nama_stackholder' type='text' value='' type="text" class="form-control" id="nama_stackholder" name="nama_stackholder" placeholder="Nama Stackholder">
											</div>
											<div class="form-group col-md-6">
												<label for='nomor_mou_pks'>Judul MOU/PKS</label>
												<input name='judul' id='judul' type='text' value=''  type="text" class="form-control" id="judul" name="judul" placeholder="Judul MoU/PKS">
												
											</div>
											<div class="form-group col-md-6">
												<label for='nomor'>Nomor Mou / PKS</label>
												<input  id='nomor' type='text' value=''  type="text" class="form-control" id="nomor" name="nomor" placeholder="Nomor MoU/PKS">
											</div>
											...
											<div class="form-group col-md-3">
												...
												<div class="input-group date" id="tanggal_mou_pks" data-target-input="nearest">
													<input type="date" class="form-control" name="tanggal_mulai" required value="">
												</div>
											...
											<div class="form-group col-md-3">
												...
												<div class="input-group date" id="tanggal_berakhir" data-target-input="nearest">
													<input type="date" class="form-control" name="tanggal_akhir" required value="">
											...
											<div class="form-group col-md-6">
												...
												<textarea name='keterangan' id='fc_keterangan' class="form-control"  placeholder="Keterangan"></textarea>
										...
										<div class="card-footer">
											...
											<div class="col">
												<div class="form-group">
													<a href="http://ptm.atrbpn.go.id/mou_pks" class="form-control btn btn-secondary"><label for='fc_s_t'>Tutup</label></a>
												</div>
											</div>
											<div class="col">
												<div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$("#postForm").submit(function(event){
	        ...
	        var post_url = '<?php echo base_url("moupks/create") ?>'; //get form action url
