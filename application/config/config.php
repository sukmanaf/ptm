...
/*
  ...
  | to $_SERVER['SERVER_ADDR'] if available, or loccalhost otherwise.
  ...
  |
 */
//$config["base_url"] = 'http://113.20.29.25:16980/candra/eplanning';
//$config['base_url'] = 'http://localhost/eplanning';
...
/*
  ...
  |
 */
//$config['permitted_uri_chars'] = 'a-z 0-9~%.:_\-'; old setting
...
$config['csrf_token_name'] = 'tokn';
$config['csrf_cookie_name'] = 'toksn';
...
//    8 => ['r_komponen', 'kd_komponen', 'nama_komponen'],
    8 => ['v_komponen', 'kdkmpnen', 'nmkmpnen'],
...
//            12=>['r_program', 'kd_program', 'nama_program'],
    ...
    14 => ['r_sasaran_pembangunan_nasioanl', 'kd_sasaran_pembangunan', 'uraian'],
...
//    18 => ['r_sub_output', 'kd_sub_output', 'nama_sub_output'],
    18 => ['v_sub_output', 'kdsoutput', 'nmsoutput'],
...
//    30 => ['r_output', 'kd_output', 'nama_output'],
    ...
    33 => ['v_ruas', 'id_ruas', 'linkname'],
    34 => ['v_module', 'kode_module', 'nama_module'],
    35 => ['v_segmen_ruas', 'no_ruas', 'no_segment']
);
